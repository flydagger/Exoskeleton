...
Author: Phoenix Fan
Date: 29-10-2019
Specification:  Check function getLinkState().
                Add base status.
                Modify deadline to 0.15.
                Decrease the survival reward.
"""
...
class BipedRobot(gym.Env):
    ...
    def reward(self, dead):
        ...
        return 0.9*x_reward + 0.04*y_reward + 0.01*z_reward + 0.01*survival
