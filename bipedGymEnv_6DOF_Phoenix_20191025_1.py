...
Specification:  Recover penaly on y axis and z axis.
                Change control mode to POSITION_CONTROL
"""
...
class BipedRobot(gym.Env):
    ...
    def load_bot(self):
        loc = '/home/antikythera1/workplace/Exoskeleton/biped_6DOF_20191024.urdf'
        self.center_datum[:, :] = 0.
    ...
    def get_limitation_space(self):
        ...
        for joint_index in range(1, self.number_joint):
            ...
            action_limit[joint_index - 1] = [-joint_info[8], joint_info[9]]  # joint position limitation for action_space
        ...
        # torque_lower_limit, torque_upper_limit = zip(*action_limit)
    ...
    def reward(self, dead):
        ...
        return 0.9*x_reward + 0.04*y_reward + 0.04*z_reward + 0.02*survival
