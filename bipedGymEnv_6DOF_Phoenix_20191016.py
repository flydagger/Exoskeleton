...
Author: Phoenix Fan
Date: 16-10-2019
Specification:  Add orientation and orientation_variance of each link into observation.
                Orientation_variance means the difference of orientation between time steps.
                Modify observation_space according to the new observation.
                Change the datum point from torso center to the center of the whole robot.
                Add a small reward for each time step survived.
                Decrease the dead height to 0.3
                Modify lowestTorsoCenterHeight & avgTorsoCenterHeight.
                Remove self.previous_position_torso (replaced by center of the whole robot)
"""
...
class BipedRobot(gym.Env):
    ...
    def reward(self, dead):
        ...
        return x_reward + y_reward + z_reward + survival
