...
Author: Phoenix Fan
Date: 01-11-2019
Specification:  Modify survival coefficient to 0.05.
"""
...
class BipedRobot(gym.Env):
    ...
    def load_bot(self):
        loc = '/home/antikythera1/workplace/Exoskeleton/biped_6DOF_20191101.urdf'
        self.center_datum[:, :] = 0.
    ...
    def reward(self, dead, observations):
        ...
        return 20*x_reward + 0.1*y_reward + 0.01*z_reward + 0.05*survival + 0.005*joint_efficiency
    ...
    def done(self):
        ...
        :return:
        """
        if self.torso_position[1, 2] < self.deadLine or self.time_limit > 240 * 10:
            return True
        return False
